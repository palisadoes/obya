...
from obya import AgentAPIVariable
from obya.daemon.daemon import Daemon
...
class AgentAPI(Agent):
    """API agent that serves web pages.
...
class _StandaloneApplication(BaseApplication):
    ...
    def load_config(self):
        ...
        print('''{} Agent {} - Application Gunicorn configuration\
